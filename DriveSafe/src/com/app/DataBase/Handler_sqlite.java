...
public class Handler_sqlite extends SQLiteOpenHelper{
	 ...
	 * de acuerdo al tipo de ordenamiento
	 * @param t Es el tipo de ordenamiento solicita.
	 * De las cuales son: 
	 * PorFecha, PorVelocidad, PorHora
	 * 
	 * @return Devuelve un arreglo con los datos de la tabla.
	 */
	public String[] consultarRegistro(TipoOrdenamiento t)
	{
		...
		{
			case PorVelocidad:
				c = this.getReadableDatabase().query("Conductor",columnas,null,null,null,null,"velocidad");
			break;
			case PorHora:
